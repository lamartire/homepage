<template>
  <page-template>
        ...
        <two-cols-block class="about-page-intro">
          ...
          <div slot="right" class="about-page-intro-content">
            ...
            <p>
              ...
              to hear the full story and learn how automating financial
              compliance with Artificial Intelligence can both delight customers
              and prevent financial crime and identity theft:
            </p>
          </div>
        </two-cols-block>
          ...
          <div slot="left">
            <div class="about-page-relative-content">
              ...
              <p>
                ...
                as they have an appetite for growth and solving complex
                problems.
              </p>
            </div>
          </div>
                  ...
                  <Person>
                    ...
                    <template>
                      <p>
                        ...
                        raps. Before starting Endpass, she was the solo-founder
                        of profitable startup, SalesFolk. Under her leadership,
                        SalesFolk helped more than 830 companies optimize their
                        sales and marketing email campaigns, and pioneered many
                        of the standards and best practices for modern inside
                        sales.
                      </p>
                      <p>
                ...
                <div class="column is-6">
                  <Person>
                    ...
                    <p>
                      ...
                      he was the CEO of Mixrank, a Y Combinator startup that was
                      one of the earliest sales automation and company discovery
                      platforms. He grew MixRank from a two-person startup to
                      one of the fastest growing companies in America as
                      recognized in the Inc 5000. He holds a degree in
                      Psychology from the University of Wisconsin-Madison, and
                      enjoys home automation and close-up magic in his spare
                      time.
                    </p>
                  </Person>
                </div>
          ...
          <two-cols-block class="about-page-mission-content">
            ...
            <div slot="right" class="about-page-mission-text">
              <div class="about-page-relative-content">
                ...
                <p>
                  However, identity theft and other cybercrime are more rampant
                  than the stagecoach and train robberies of the 1800’s.
                  Unfortunately, government and its borders are not equipped to
                  protect citizens from malicious actors around the world.
                </p>
                <p>
                  Just as entrepreneurs have always risen to solve problems that
                  governments and large organizations cannot, Endpass aims to
                  make a dent in cybercrime and money laundering with Artificial
                  Intelligence.
                </p>
                <p>
                ...
                <p>
                  We’re building better automated financial compliance tools to
                  help banks and cryptocurrency exchanges to more accurately and
                  efficiently validate of identities. This means a seamless
                  onboarding experience for legitimate customers doing KYC and
                  AML, and stopping fraudsters and terrorists from slipping
                  through the cracks.
                </p>
                <p>But this is just the start.</p>
                <p>
                  Ultimately our AI will be able to develop
                  <strong>“digital fingerprints”</strong> that correlate
                  fraudulent documents and accounts to the original source,
                  making a dent in global black markets. Not only can this be
                  used by financial institutions, but by law enforcement and
                  governments, as well as any organization that needs to
                  validate the identity of its customers, vendors, and
                  employees.
                </p>
              </div>
            </div>
    ...
    <page-footer skin="dull" slot="footer">
