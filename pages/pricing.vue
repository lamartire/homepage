        ...
        <div class="columns is-variable is-4">
          <div class="column is-offset-2 is-8">
            <page-intro>
              ...
              <p>
                Partner with Endpass to automate identity verification for your
                organization, and you'll also help fight global fraud and
                cybercrime.
              </p>
            </page-intro>
          </div>
        ...
        <div class="pricing-page-cards columns is-variable is-4">
          <div class="pricing-page-price column is-offset-2 is-4">
            <pricing-card :is-primary="true">
              ...
              <markered-list-item
                >AI powered instant identity verification</markered-list-item
              >
              <markered-list-item
                >Automated KYC/AML compliance</markered-list-item
              >
              <markered-list-item
                >Continuous sanctions list monitoring</markered-list-item
              >
              <markered-list-item
                >Easy to use compliance dashboard</markered-list-item
              >
              <markered-list-item
                >OAuth standard single sign on</markered-list-item
              >
              <markered-list-item>Full API access</markered-list-item>
              <markered-list-item
                >Simple to integrate mobile SDK</markered-list-item
              >
          ...
          <div class="pricing-page-price column is-4">
            <pricing-card>
              ...
              <markered-list-item
                ><strong
                  >Everything in the Pay as You Grow Plan</strong
                ></markered-list-item
              >
              <markered-list-item
                >Corporate identity provider integration</markered-list-item
              >
              <markered-list-item>Full audit log</markered-list-item>
              <markered-list-item>Custom integrations</markered-list-item>
              <markered-list-item
                >Granular verification rules</markered-list-item
              >
