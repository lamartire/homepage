<template>
  <div class="landing">
    ...
    <two-cols-image-block>
      ...
      <template slot="content">
        ...
        <p>
          ...
          250% higher match accuracy, giving you world-class compliance with far
          less manual work.
        </p>
        <p>
          Unlike most compliance solutions that only check sanctions lists
          during registration, we continuously monitor all lists to ensure none
          of your customers are violating sanctions or anti money laundering
          laws.
        </p>
      </template>
    </two-cols-image-block>
    <two-cols-with-list-block>
      <template slot="title">
        Smart automation means smoother customer onboarding, happier customers,
      ...
      <template slot="content">
        <p>
          We know you have to verify your customers’ identities to meet KYC and
          AML requirements, but complicated registration processes could be
          costing you customers.
        </p>
        <p>
          According to Deloitte, 37% of financial customers will abandon signup
          if they feel onboarding takes too long. And over a quarter of
          customers pick financial institutions based on ease of enrollment and
          sign in.
        </p>
        <p>
          With Endpass, financial customers upload their documents for identity
          validation just once. After that, they can securely share their
          information to register or sign in with any Endpass-integrated
      ...
      <template slot="list">
        ...
        <li>Higher verification accuracy</li>
        <li>Stronger fraud and risk protection for your institution</li>
      </template>
    ...
    <two-cols-features-block>
      ...
      <template slot="features">
        <li>
          <feature
            title="Advanced Data Science powered by AI"
            icon="feature-4"
            is-horizontal
          >
        ...
        <li>
          <feature
            title="Eliminationg expensive false negatives"
            icon="feature-5"
            is-horizontal
          >
    ...
    <centered-text-block>
      ...
      <template slot="content">
        Why not fortify your company’s security while making it easier for users
        to sign in or register with the option to use Endpass Single Sign On?
      </template>
      <template slot="link">
      ...
      <template slot="col-1">
        <p>
          <strong
            ...
            storage practices are the key to defeating fraud.</strong
          >
        </p>
        <p>
          That’s why we built a digital identity verification platform powered
          by the most advanced Artificial Intelligence technology to help
          financial institutions and other businesses ensure their customers are
