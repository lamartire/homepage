<template>
  <section class="careers-page">
    ...
    <div class="careers-page-perks container">
      <card-section>
        <template slot="title">
          Some of the perks of working at Endpass:
        </template>
        <template>
          <labeled-section>
            <template slot="title">
            ...
            <list>
              ...
              <list-item>
                We get you — wearing a suit sucks. Come to work in your pajamas
                or a superhero costume; we don’t care
              </list-item>
              <list-item>
                Want to work from a beach or cute cafe in Europe or Asia? As
                long as you have wifi and get shit done, we don’t care where you
                work from.
              </list-item>
              <list-item>
          ...
          <labeled-section>
            ...
            <expert>
              ...
              <template slot="name"
                >Heather R Morgan</template
              >
              <template>
                Learn sales and marketing best practices from the person who
                developed many of the industry best practices, and continues to
                pursue scientifically sound experiments (in persuasion) to
                develop cutting edge strategies to stay ahead of the competition
                and make algorithms favor you.
              </template>
            </expert>
            <expert>
              ...
              >
              <template>
                He’s been doing [xyz] since [age y] and he pioneered many of the
                technology concepts behind sales automation and growth marketing
                [starting in 2011].
              </template>
            </expert>
          </labeled-section>
    ...
    <div class="careers-page-culture">
      <two-cols-block>
        ...
        <list slot="right">
          ...
          <list-item>
            We value new ideas and diverse thinking, but we’re obsessed with
            execution and thinking of new ways to increase efficiency and
            productivity.
          </list-item>
          <list-item>
            Endpass has a fully distributed team, currently based in the United
        ...
        <v-table>
          <v-table-body>
            <v-table-row>
              ...
              <v-table-cell class="careers-page-location-cell"
                >Everywhere</v-table-cell
              >
              <v-table-cell class="careers-page-apply-cell"
                ><a href="#">Apply</a></v-table-cell
              >
            </v-table-row>
            <v-table-row>
              <v-table-cell>JavaScript Performance Engineer</v-table-cell>
              <v-table-cell class="careers-page-location-cell"
                >New York</v-table-cell
              >
              <v-table-cell class="careers-page-apply-cell"
                ><a href="#">Apply</a></v-table-cell
              >
            ...
            <v-table-row>
              <v-table-cell>Security Engineer</v-table-cell>
              <v-table-cell class="careers-page-location-cell"
                >New York</v-table-cell
              >
              <v-table-cell class="careers-page-apply-cell"
...
import ListItem from "~/components/Careers/ListItem";
...
.careers-page-location-cell {
  color: #697077;
}

.careers-page-apply-cell {
  text-align: right;
}
